...
let
  ...
  wallpaper = builtins.fetchurl {
    url = "https://raw.githubusercontent.com/sezuisa/dotfiles/master/wallpapers/wallpaper-enterprise.jpg";
    sha256 = "1djkzzdydimnznbi82cagzd31xwmhakhqbkvh0vykccyq2y2h9fp";
  };
in
